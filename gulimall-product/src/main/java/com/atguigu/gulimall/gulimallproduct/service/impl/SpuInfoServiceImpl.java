...
import com.atguigu.gulimall.gulimallproduct.feign.SearchFeignService;
...
public class SpuInfoServiceImpl extends ServiceImpl<SpuInfoDao, SpuInfoEntity> implements SpuInfoService {
    ...
    public void saveSpuInfo(SpuSaveVo spuInfo) {
        ...
        this.savaBaseSpuInfo(infoEntity);
        ...
        if (skus != null && skus.size() > 0) {
            skus.forEach(item->{
                ...
                // 6.4 sku的优惠、满减等信息 gulimall_sms->sms_sku_ladder\sms_sku_full_reduction\sms_memeber_price
    ...
    @Override
    public void savaBaseSpuInfo(SpuInfoEntity infoEntity) {
